...
function paintFront( g , diy , sheet ){
	...
	case 'Title' :
		sheet.paintImage( g , getIcon( 'EncounterSet' ) , 'Icon-TitleLeft-region' ) ;
		sheet.paintImage( g , getIcon( 'Collection' ) , 'Icon-TitleRight-region' ) ;
		writeName( g , diy ) ;
		break ;
	default :
...
function paintBack( g , diy , sheet ){
	...
	switch( String($Layout) ){
	case 'Title' :
		sheet.paintImage( g , $Template+'-Title' , 'Template' ) ;
		...
		sheet.paintImage( g , getIcon( 'EncounterSet' ) , 'Icon-'+setPosition ) ;
		sheet.paintImage( g , getIcon( 'Collection' ) , 'Icon-'+colPosition ) ;
		writeName( g , diy ) ;
		break ;
	default :
		sheet.paintImage( g , $Template+'-'+layout , 'Template' ) ;
	...
	if( diy.settings.getBoolean( 'ShowBleeding' ) ) sheet.paintImage( g , 'Template-Bleeding.png' , 'Template' ) ;
	if( diy.settings.getBoolean( 'ShowCutBig' ) ) sheet.paintImage( g , 'Template-CutBig-'+layout , 'Template' ) ;
	if( diy.settings.getBoolean( 'ShowCut' ) ) sheet.paintImage( g , 'Template-Cut-'+layout , 'Template' ) ;
}
