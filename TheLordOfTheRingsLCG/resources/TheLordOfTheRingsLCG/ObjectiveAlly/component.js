...
// TEMPLATE
	...
	case 'Standard' : break ;
	case 'Custom' :
		paintDifficulty( $Difficulty , 'Objective-Ally' , g , sheet ) ;
		break ;
	default :
		paintDifficulty( $Difficulty , 'Objective-Ally' , g , sheet ) ;
		break ;
...
// ICONS
	...
	if( $Template != 'Boon' ) paintIcon( 'EncounterSet' , g , diy , sheet ) ;
...
// TEXTS
	...
	if( $Template != 'Boon' ){ writeEncounterSetNumber( g , diy ) ; }
